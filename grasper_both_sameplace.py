...
init_ori = [0, -1.57, 0]
grasp_ori = [0,0,1] # Top grap [0,0,0] or side grasp [1.57,0,0]
hand = "left"
object_z = 0.07
...
for i in range(35, 45, 10):
    ...
    # Left
    grasper.pick_object([0.35,0.0,object_z+0.001*i], grasp_ori, "left")
    grasper.place_object([0.45,0.0,object_z+0.001*i], grasp_ori, "left")
    grasper.init_position(init_pos_l, init_ori, "left")
    # Right
    grasper.pick_object([0.45,0.0,object_z+0.001*i], grasp_ori, "right")
    grasper.place_object([0.35,0.0,object_z+0.001*i], grasp_ori, "right")
    grasper.init_position(init_pos_r, init_ori, "right")
