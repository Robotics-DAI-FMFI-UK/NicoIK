...
for i in range(35, 45, 10):
    ...
    # Pick object
    grasper.pick_object([i/100,0.1,object_z+0.001*i], grasp_ori, "left")
    grasper.pick_object([i/100,-0.1,object_z+0.001*i], grasp_ori, "right")
    # Place object
    grasper.place_object([i/100,init_pos_l[1],0.05], grasp_ori, "left")
