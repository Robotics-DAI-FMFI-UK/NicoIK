...
init_pos_tiago = {  # standard position
...
def main():
    ...
    if arg_dict["real_robot"]:
        ...
        time_res = check_execution(robot, init_pos.keys(), list(init_pos.values()), JOINTACCURACY, arg_dict["verbose"])
        ...
        for i in range(1000):
            ...
            if arg_dict["initial"]:
                ...
                if arg_dict["real_robot"]:
                    ...
                    time_res = check_execution(robot, actuated_joints, actuated_initpos, JOINTACCURACY, arg_dict["verbose"])
            ...
            if arg_dict["real_robot"]:
                ...
                #time_ex = check_execution(robot, actuated_joints, targetdeg, JOINTACCURACY, arg_dict["verbose"])
